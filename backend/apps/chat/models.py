...
class Conversation(models.Model):
    ...
    # Uniqueness for a pair: store sorted "<userA_id>:<userB_id>"
    ...
    def __str__(self): return f"DIRECT:{self.pk}"
...
class Message(models.Model):
    ...
    sender = models.ForeignKey(User, on_delete=models.PROTECT, related_name="sent_messages", db_index=True)
